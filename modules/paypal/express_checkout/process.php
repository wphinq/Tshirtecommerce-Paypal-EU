...
class PaypalExpressCheckout extends Paypal
{
    ...
    private function initParameters()
    {
        ...
        if (Module::isInstalled('tshirtecommerce') && Module::isEnabled('tshirtecommerce')) {
            $this->product_list = $this->context->cart->getProducts(true, false, null, true);
        } else {
            $this->product_list = $this->context->cart->getProducts(true);
        }
        /* \End Updated by phinq */
